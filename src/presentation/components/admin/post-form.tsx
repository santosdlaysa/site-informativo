...
export function PostForm({ action, categories, post, currentCategoryId }: PostFormProps) {
  ...
  return (
    <form action={formAction}>
      ...
      <div className="typebar">
        <label className="type-opt active">
          <input type="radio" name="type" value={PostType.Standard} defaultChecked hidden />
          <span className="ti">
        ...
        <div className="type-opt" title="Em breve" style={{ opacity: 0.55 }}>
          <span className="ti">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
